...
public class ProductResourceIT {
    ...
    public void findAllShouldReturnSortedPageWhenSortByName() throws Exception {
        ...
        result.andExpect(status().isOk());//status 200
        result.andExpect(jsonPath("$.totalElements").value(countTotalProducts)); // O valor do comapo totalElement do Json é 25?
    ...
    public void updateShouldReturnProductDtoWhenIdExists() throws Exception {
        ...
        ProductDTO productDTO = Factory.creaProductDTO();
